...
class ConferenceFixture extends AbstractFixture
{
	...
	protected function getConferences(): iterable
	{
		yield [
			...
			'genre' => 'Technology',
			'place' => 'Prague',
			'startsAt' => new DateTime('2024-05-01 09:00:00'),
			'endsAt' => new DateTime('2024-05-01 17:00:00'),
			'priceForSeat' => 1000,
			'capacity' => 200,
		...
		yield [
			...
			'genre' => 'Marketing',
			'place' => 'Brno',
			'startsAt' => new DateTime('2024-06-15 10:00:00'),
			'endsAt' => new DateTime('2024-06-15 16:00:00'),
			'priceForSeat' => 750,
			'capacity' => 150,
